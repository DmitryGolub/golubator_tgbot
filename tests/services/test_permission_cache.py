...
class TestPermissionCache:
    ...
    async def test_role_set_and_get(self, mock_get_redis):
        ...
        data = {"id": 1, "name": "mentor", "display_name": "M", "is_mentor": True, "is_student": False}
    ...
    async def test_invalidate_user(self, mock_get_redis):
        ...
        await set_cached_role(100, {"id": 1, "name": "m", "display_name": "M", "is_mentor": True, "is_student": False})
